...
var Menu3 = React88.forwardRef(function Menu4(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React88.Children.map(children, (child, index2) => {
...
var NativeSelectInput = React89.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
...
var SelectInput = React90.forwardRef(function SelectInput2(props, ref) {
  ...
  const displayRef = React90.useRef(null);
  const [displayNode, setDisplayNode] = React90.useState(null);
  const {
    current: isOpenControlled
  } = React90.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React90.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React90.useCallback((node) => {
  ...
  React90.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  const childrenArray = React90.Children.toArray(children);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime72.jsxs)(React90.Fragment, {
...
var Select3 = React92.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime74.jsx)(React92.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-O2LUM7CE.js.map
